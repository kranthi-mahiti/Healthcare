...
public class PatientFormActivity2 extends AppCompatActivity {
    Button btn_continue;
    TextView t1, t2, t3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_patient_form2);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PatientFormActivity2.this, PatientFormActivity3.class);
                startActivity(i);
            }
        });
    }
